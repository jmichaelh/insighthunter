...
const corsMiddleware = (context: APIContext, next: MiddlewareNext) => {
...
const rateLimitMiddleware = async (context: APIContext, next: MiddlewareNext) => {
...
const authMiddleware = (context: APIContext, next: MiddlewareNext) => {
...
export const onRequest = defineMiddleware(
  (context, next) => corsMiddleware(context, () => 
